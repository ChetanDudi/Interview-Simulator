...
{
    Task<CreateSessionResult>             CreateAsync(Guid userId, Guid resumeId, int questionCount = 8, string? targetRole = null, string? sessionType = null, CancellationToken cancellationToken = default);
